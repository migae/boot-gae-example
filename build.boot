...
(set-env!
 :asset-paths #{"assets"}
 :resource-paths #{"src/main/webapp" "src/main/clojure" "resources/templates"}
 :source-paths #{"src/main/clojure" "resources/templates"}
 :target-path "build"
 ...
 :gae {;; :build-dir "build/exploded-app"
